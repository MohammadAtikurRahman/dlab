...
//             if (new Date(entry.video_end_date_time) > new Date(dayWiseData[day].latestEndTime)) {
//               dayWiseData[day].latestEndTime = entry.video_end_date_time;
//             }
//           }
//         });
